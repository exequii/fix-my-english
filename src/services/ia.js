const COHERE_API_KEY = 'JXQmsFmfVnZnJHXuUugaO3tOyljCpDySQUbrXGrv'
const COHERE_API_GENERATE_URL = 'https://api.cohere.ai/generate'
const COHERE_API_DETECT_URL = 'https://api.cohere.ai/detect-language'
...
export async function checkIsEnglish(input){
    ...
    const { results } = await fetch(COHERE_API_DETECT_URL, {
        method: 'POST',
        headers: {
